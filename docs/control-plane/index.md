...
## Document Map
* [/control-plane/monarch-controller.md](/control-plane/monarch-controller.md) - Core reconciliation engine loop layout, CRD structure specifications, and dependency injection tracks.
