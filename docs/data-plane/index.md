...
* [/data-plane/egress-record-replay.md](/data-plane/egress-record-replay.md) — Kaisel eBPF request/response pairing seeds Shop → Envoy egress replay; Shop Put first-2xx dedup.
