...
## Plan 1 completion (Monarch)

Monarch Plan 1 is complete when shadow pods inject **only** the Envoy sidecar (no OTel Operator, no language detectors). See [/control-plane/monarch-controller.md](/control-plane/monarch-controller.md).
