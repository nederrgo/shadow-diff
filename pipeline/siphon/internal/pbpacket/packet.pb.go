...
type Packet struct {
	...
	Pcap          *any1.Any              `protobuf:"bytes,1,opt,name=pcap,proto3" json:"pcap,omitempty"`
...
func (x *Packet) GetPcap() *any1.Any {
	if x != nil {
		return x.Pcap
	}
	return nil
...
const file_packet_proto_rawDesc = "" +
	"\n" +
	"\fpacket.proto\x12\bpbpacket\x1a\x19google/protobuf/any.proto\"2\n" +
	"\x06Packet\x12(\n" +
	"\x04pcap\x18\x01 \x01(\v2\x14.google.protobuf.AnyR\x04pcap\"\x10\n" +
	"\x0eCollectorReply2A\n" +
	"\tCollector\x124\n" +
	"\x04Send\x12\x10.pbpacket.Packet\x1a\x18.pbpacket.CollectorReply\"\x00B1Z/github.com/shadow-diff/siphon/internal/pbpacketb\x06proto3"
